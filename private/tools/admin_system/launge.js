const LAUNGE = {
  Polski: {
    ...
    menu_label_zarzadzaj_uzytkownikami: "Zarządzaj użytkownikami",
    menu_otworz_uzytkownikow: "Przeglądaj użytkowników",
    menu_zapisz_uzytkownika: "Dodaj nowego użytkownika",
    menu_edytuj_uzytkownika: "Edytuj użytkownika",
    menu_usun_uzytkownika: "Usuń użytkownika",
    // alerty i komunikaty
    alert: "Alert!",
  ...
  English: {
    ...
    menu_label_zarzadzaj_uzytkownikami: "Manage users",
    menu_otworz_uzytkownikow: "Browse users",
    menu_zapisz_uzytkownika: "Add new user",
    menu_edytuj_uzytkownika: "Edit user",
    menu_usun_uzytkownika: "Delete user",
    // alerty i komunikaty
    alert: "Alert!",
  ...
  Svenska: {
    ...
    menu_label_zarzadzaj_uzytkownikami: "Hantera användare",
    menu_otworz_uzytkownikow: "Bläddra bland användare",
    menu_zapisz_uzytkownika: "Lägg till ny användare",
    menu_edytuj_uzytkownika: "Redigera användare",
    menu_usun_uzytkownika: "Ta bort användare",
    // alerty i komunikaty
    alert: "Varning!",
